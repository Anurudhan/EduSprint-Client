        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            ...
            <p className="text-gray-400">
              Empowering educators and learners worldwide through accessible, quality education.
            </p>
          </div>
          <div>
          ...
          <div>
            ...
            <div className="mt-4">
              <a href="mailto:contact@eduplatform.com" className="flex items-center text-gray-400 hover:text-white">
